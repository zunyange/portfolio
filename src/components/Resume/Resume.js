            ...
            <S.ContentBox>
              ...
              <S.Content>
                <div>
                  ...
                  13와 같은 트렌드로 자주 다뤄지는 프레임워크를 학습할 뿐만
                  ...
                  진행 중이며 배포 자동화하였습니다. 그 외에도 Next.js 등 제가
                  학습하고 싶은 요소를 이용한 프로젝트를 직접 기획해
                  개발해보기도 합니다. 또한 도전하는 환경을 만들기 위해 제가
                  참여할 수 있는 일을 찾아 적극적으로 제안하고 현재는 AWS
                  클라우드 역량 강화/서비스 활용를 위해 AWS Builders 온라인
                  시리즈 교육 중입니다.
                </div>
              </S.Content>
            </S.ContentBox>
            ...
            <S.ContentBox>
              ...
              <S.Content last="true">
                <div>
                  ...
                  코드를 업데이트하고 형식에 맞게 커밋 메시지를 작성하는 것을
                  잊지 않습니다. 또한 협업 시 Github 플로우와 같은 업무 흐름을
                  이해하고 지키며 혼란 없이 코드에만 집중할 수 있도록
                  노력합니다.
                  {/* 결과적으로 인턴 경험 때에 진행했던 프로젝트의
                ...
                <div>
                  &nbsp;이러한 제 장점들을 살린 프로그래밍 능력들을 더욱
                  발전시키기 위해 다른 개발자들과 자주 소통을 하며, 생각을
                  깔끔하게 정리하기 위해{' '}
                  <a
