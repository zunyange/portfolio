          ...
          <S.ResumeBox one>
            ...
            <S.ContentBox>
              ...
              <S.Content>
                ...
                솔루션을 배웠습니다. 이를 통해 아이디어를 직접 그려내기도 하며,
                유저에게 빠르게 피드백을 받고 소통할 수 있다는 점에서 프론트엔드
                개발자로써 제 역량을 발휘할 자신이 있습니다.
                <br />
                현재는 프로젝트에서 필연적인 PET 분석을 통해 우리 팀의 서비스
                가치를 확립하는 과정에서 흥미를 찾았고, 개발자는 수많은
                결정사항과 작업에 대해 서로 소통하고 협업하며 문제를 해결해
                나가는 역할임을 깨달았습니다. 또한, 타인을 오롯이 존중하는
