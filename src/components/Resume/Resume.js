          ...
          <S.ResumeBox one>
            ...
            <S.ContentBox>
              ...
              <S.Content>
                ...
                솔루션을 배웠습니다. 이를 통해 아이디어를 직접 그려내고
                구현해내며 유저에게 빠르게 피드백을 받고 소통할 수 있다는 점에서
                프론트엔드 개발자로 결정했습니다. <br />
                현재는 프로젝트에 있어서 필연적인 PET 분석을 통해 우리 팀의
                서비스 가치를 확립하는 과정에서 흥미를 찾았고, 개발자는 수많은
                결정사항과 작업에 대해 서로 소통하고 협업하며 문제를
                해결해나가는 역할임을 깨달았습니다. 또한, 타인을 오롯이 존중하는
          ...
          <S.ResumeBox three>
            ...
            <S.ContentBox>
              ...
              <S.Content last>
                ...
                않습니다. 또한 협업 시 Github 플로우와 같은 업무 흐름을 이해하고
                지키며 혼란 없이 코드에만 집중할 수 있도록 노력합니다.
                결과적으로 인턴 경험 때에 진행했던 프로젝트의 기간이
                종료됐음에도 현재 기업에서 유지 보수를 하여 현재{' '}
                <a
                ...
                운영 중입니다.
                <br />
                이러한 제 장점들을 살린 프로그래밍 능력들을 더욱 발전시키기 위해
                다른 개발자들과 자주 소통을 하며, 생각을 깔끔하게 정리하기 위해{' '}
                <a
                ...
                사람들과 공유하고 피드백을 나누는 것을 중요한 가치라고 여깁니다.
              </S.Content>
            </S.ContentBox>
          </S.ResumeBox>
          <S.PotentWrap>
